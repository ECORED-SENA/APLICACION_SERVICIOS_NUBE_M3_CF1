      ...
      .py-4.py-md-5(titulo="Bases de datos con estructura relacional" :icono="require('@/assets/template/tema-1-8.svg')")
        .row
          .col-12.col-lg-6
            ...
            p Es estas bases de datos son multipropósito, lo que las hace las más extendidas en la industria y más empleadas, pero son las más complejas de aprender; por lo que solo se abordará el diseño e implementación de este tipo de bases de datos. Se basan tablas como las que se presentó en la figura 1 y en la relación de los datos de unas tablas con otras.
          .col-8.col-lg-6.offset-2.offset-lg-0
            figure.mt-5
