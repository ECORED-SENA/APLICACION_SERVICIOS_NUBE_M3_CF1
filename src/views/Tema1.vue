...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mt-5 El concepto general de bases de datos según la RAE es el “conjunto de datos organizado de tal modo que permita obtener con rapidez diversos tipos de información” (RAE ,2001). De acuerdo con esta definición, una hoja de cálculo de Excel puede considerarse una base de datos, o un conjunto de archivos debidamente organizados, o la lista de nombres y teléfonos que está en nuestros smartphones. En principio, es correcto llamarle base de datos a estos ejemplos, sin embargo, en el contexto de desarrollo de software, se referirá a ese conjunto de información que puede ser almacenada en grandes cantidades de forma organizada y es gestionada a través de un #[strong Sistema de Gestión de Bases de Datos] (SGBD).
    p.mt-4 Para organizar y definir la información de forma sistemática, las bases de datos también deben poder almacenar una descripción precisa de los datos que contiene conocida como #[strong metadatos] a los que se le relaciona el tipo de información que es conceptualmente guardada (es decir si se agrega una explicación de la naturaleza del dato en la empresa) se da origen a lo que conoce como #[strong diccionario de datos o catálogo de datos].
    p.h4.mt-5 Ejemplo 1
    ...
    p.mt-5 Los metadatos de la figura anterior serían la definición de cada tipo de dato como se lista a continuación: 
    ...
    .row.mt-4
      .col-8.offset-2
        .cajon.color-secundario.p-4
          p.m-0 #[strong calldate TIMESTAMP(1)] 
            span.p-4 Donde 1 es el número de dígitos de milisegundos (Z).
    ...
    .row.mt-4
      .col-8.offset-2
        .cajon.color-secundario.p-4
          p.m-0 #[strong src TIME] 
            span.p-4 TIME se usa para esta estructura de dato en particular
    ...
    p.mt-3 Por lo tanto, la solución de los metadatos de la base de datos de la figura anterior es: 
    .row.mt-5
    ...
    .h6 Ejemplo 2 
    p.mt-2 Conociendo el objetivo de la base de datos y los metadatos de la figura «Base de datos de llamadas telefónicas», crear un diccionario de datos o un catálogo de datos..
    .h6.mt-4 Solución:
    ...
    p.mt-4 Las bases de datos han evolucionado a lo largo del tiempo, usando diferentes tipos de modelos o enfoques, se ha comprobado que algunos de ellos tienen mejor desempeño en distintos tipos de aplicación. La estructura en la que se configuran los datos al interior de las bases de datos es una forma de clasificación:
    TabsB.color-secundario.mb-5
      .py-4.py-md-5(titulo="Bases de datos con estructura jerárquica" :icono="require('@/assets/template/tema-1-6.svg')")
        .row
          .col-12.col-lg-6
      ...
      .py-4.py-md-5(titulo="Bases de datos con estructura en red" :icono="require('@/assets/template/tema-1-7.svg')")
        .row
          .col-12.col-lg-6
            ...
            p Esta estructura es un poco más compleja que la anterior porque contiene otras relaciones de las jerárquicas admitiendo relaciones de cada registro con otros, de manera tal que puede seguir distintos caminos para acceder a la información.
          .col-8.col-lg-6.offset-2.offset-lg-0
            figure.mt-5
              img(src="@/assets/template/tema-1-12.svg" alt="Texto que describa la imagen")
      .py-4.py-md-5(titulo="Bases de datos con estructura relacional" :icono="require('@/assets/template/tema-1-8.svg')")
        .row
          .col-12.col-lg-6
      ...
      .py-4.py-md-5(titulo="Bases de datos con estructura multidimensional" :icono="require('@/assets/template/tema-1-9.svg')")
        .row
          .col-12.col-lg-6
          ...
          .col-8.col-lg-6.offset-2.offset-lg-0
            figure.mt-5
              ...
              p.mt-5.h6.text-center Estructura de datos de cubo
      .py-4.py-md-5(titulo="Bases de datos con estructura orientada a objetos" :icono="require('@/assets/template/tema-1-10.svg')")
        .row
          .col-12.col-lg-6
          ...
          li.mb-0.d-block.mt-1
            .row
              .col-1
                i.fas.fa-angle-right.color-azul
              .col-11.vinetas-lm
                p.mb-2 Proporcionan un acceso controlado a la base de datos (con autenticación, roles, niveles de acceso).
          li.mb-0.d-block.mt-1
            .row
              .col-1
                i.fas.fa-angle-right.color-azul
          ...
          li.mb-0.d-block.mt-1
            .row
              .col-1
                i.fas.fa-angle-right.color-azul
              .col-11.vinetas-lm
                p.mb-2 Algunos SGDB permiten administrar el catálogo de datos. 
