...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .h6.mt-5 Entidad relación persona cuenta bancaria
    figure.mt-5
      img(src="@/assets/template/tema-2-2.png" alt="Texto que describa la imagen")
    p.mt-5 Para una base de datos de un sistema bancario consistente en clientes (es decir personas) y sus cuentas bancarias, en la figura anterior se muestra el diagrama Entidad Relación correspondiente. En él se indica que hay dos entidades que son persona y cuenta, con los atributos descritos anteriormente para cada una. El diagrama también representa la relación titular entre persona y cuenta.
    p.mt-3 Se debe tener en cuenta que el modelo relacional convierte las entidades en tablas, por lo tanto, se puede poner como ejemplo que las entidades personas se conviertan en tablas como muestra la siguiente figura.
    .h6.mt-5 Tablas de una entidad relación
    figure.mt-5
    ...
    p.mt-4 En una base de datos relacional, las relaciones permiten evitar datos redundantes. En el ejemplo anterior una persona pudiera tener varias cuentas bancarias, pero no es deseable que, por cada una de las cuentas bancarias asociadas a la misma persona, se deban repetir los datos de la misma persona, sino, más bien, que se debe encontrar un mecanismo para relacionar la información de las dos tablas; y para ello se introducen algunos conceptos útiles.  
    .h4.mt-5 Claves
    ...
    .h4.mt-5 Ejemplo: 
    p.mt-4 En la tabla persona de la figura  «Tablas de una entidad relación», es sabido por todos que no existen dos personas con el mismo número de documento de identidad, por lo tanto, se puede emplear el atributo #[strong identificación] como clave de la tabla persona.  Así mismo, no deben existir dos cuentas bancarias con el mismo número de cuenta, entonces, el atributo #[strong numero_cuenta] se puede emplear como clave de la tabla cuenta. Esto se puede presentar en un diagrama de entidad relación cuando a los atributos que componen una clave se les marca con subrayado el nombre del atributo tal como se muestra en la siguiente figura.
    .h6.mt-5 Claves de las entidades persona y cuenta
    figure.mt-5
    ...
    .h6.mt-5 Claves candidata, superclave y clave primaria 
    ...
    .h6.mt-5 Claves candidatas
    figure.mt-5
      img(src="@/assets/template/tema-2-6.png" alt="Texto que describa la imagen")
    .h6.mt-5 Clave candidata
    p.mt-4 Los dos caminos propuestos en la figura anterior son válidos, y se denominan claves candidatas porque con ambas se puede lograr el principio de unicidad, y es potestad de cada diseñador o analista de sistemas determinar cuál de las dos emplear.
    ...
    .h6.mt-5 Claves candidatas secuencia
    .row.mt-5
    ...
    .h4.mt-5 Superclave
    p.mt-4 Es un conjunto de uno o más atributos que, tomados juntos, permiten identificar de forma única una entidad en el conjunto de entidades. Por ejemplo, el atributo #[strong id_persona] del conjunto de entidades persona es suficiente para distinguir una persona cliente del banco de las otras. Así, #[strong id_persona] es una superclave. Análogamente, la combinación de #[strong identificación y país] es una superclave del conjunto de entidades persona. El atributo correo de persona es otra superclave, pero el atributo #[strong nombres] no lo es porque varias personas podrían tener el mismo nombre.
    ...
    .h6.mt-5 Relaciones de uno a muchos
    figure
    ...
    p.mt-4 Como se puede ver en la figura anterior, Ana Lis Méndez, es titular de dos cuentas bancarias (67.789.901 y 32.443.171), y todos los datos de la columna titular en la tabla cuenta se conoce como #[strong LLAVE FORANEA] de la tabla persona; de esta forma se puede concluir.
    .row.mt-4
      .col-8.offset-2 
        .cajon.color-secundario.bg-secundario-op10.p-4
    ...
    .h6.mt-5.text-center Diagrama relacional 1:N con metadatos
    .row.mt-5
      .col-10.col-md-8.col-lg-6.offset-1.offset-md-2.offset-md-3
        figure
    ...
    .titulo-segundo.mt-5
      #t_2_3.h4 2.3  Relación de muchos a muchos
    ...
    .row.mt-5
      .col-8.offset-2 
        .cajon.color-secundario.bg-secundario-op10.p-4
          ...
          p.m-0 En una relación de muchos a muchos (N:N) se transforma en una tabla cuya llave primaria está compuesta por las llaves primarias de las otras dos tablas.
    ...
    .h6.mt-5 Diagrama relacional 1:1
    .row.mt-4
